            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  <span className="material-icons-round text-primary-600 mr-2 flex-shrink-0">
                    email
                  </span>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium text-sm">
                    Come faccio a caricare un documento?
                  </h4>
                  <p className="text-sm text-gray-600">
                    Vai alla dashboard e clicca su "Carica Documenti".
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-sm">
                  ...
                  <p className="text-sm text-gray-600">
                    Le notifiche vengono inviate all'email registrata quando un
                    documento è in scadenza.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="md:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Compila il modulo sottostante per segnalare problemi o
